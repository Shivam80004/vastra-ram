...
const LongBanner = () => {
    return (
        <section className="relative w-full h-[200px] sm:h-[300px] md:h-screen bg-black flex items-center justify-center">
            {/* Background Image */}
            {/* <div
            ...
            {/* Content Overlay */}
            <div className="absolute right-12 top-[35%] z-20 flex flex-col items-center justify-center text-center px-4 max-w-2xl">
                {/* Title */}
                <h1 className="mb-3 sm:mb-4 md:!mb-2 !text-white tracking-wide leading-tight z-20">
                    A Personal Trial, At Your Doorstep
                </h1>

                {/* Description */}
                <p className="text-sm md:text-xl text-white/90 mb-2 md:mb-6 max-w-xl font-light leading-relaxed z-20">
            ...
            <img
                src="https://cdn.shopify.com/s/files/1/0744/6108/5884/files/banner-png.png?v=1766979354"
                alt="Banner Overlay"
                className="absolute top-0 right-5 -z-10 h-[120%] sm:h-[130%] md:h-[100%] w-auto max-w-none object-contain z-10"
            />
        </section>
    );
};
